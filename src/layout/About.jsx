            ...
            >
                    ...
                    <div id="toifa_card_cata">
                      {filteredItems.slice(0, 12).map((item) => (
                        <div
                          key={item.id}
                          id="card1"
                          className=" shadow-md hover:shadow-lg text-center w-90 h-120 justify-between mx-2 rounded-sm my-3 p-3"
                        >
                          <div>
                            <img
              ...
              {selectedCategory === 2 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem12.length}
                  </p>
              ...
              {selectedCategory === 3 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem13.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem13.map((item) => (
                      <div
              ...
              {selectedCategory === 4 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem14.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem14.map((item) => (
                      <div
              ...
              {selectedCategory === 5 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem15.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem15.map((item) => (
                      <div
              ...
              {selectedCategory === 6 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem16.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem16.map((item) => (
                      <div
              ...
              {selectedCategory === 7 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem17.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem17.map((item) => (
                      <div
              ...
              {selectedCategory === 8 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem18.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem18.map((item) => (
                      <div
              ...
              {selectedCategory === 9 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem19.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem19.map((item) => (
                      <div
              ...
              {selectedCategory === 10 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem20.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem20.map((item) => (
                      <div
              ...
              {selectedCategory === 11 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem21.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem21.map((item) => (
                      <div
              ...
              {selectedCategory === 12 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem22.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem22.map((item) => (
                      <div
              ...
              {selectedCategory === 13 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem23.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem23.map((item) => (
                      <div
              ...
              {selectedCategory === 14 && (
                <div>
                  <p className="text-xl">
                    {" "}
                    Malumotlar soni: {homeItem24.length}
                  </p>
                  <div id="toifa_card_cata" className="mb-10">
                    {homeItem24.map((item) => (
                      <div
